...
## Schema state
Production migrations 0001-0010 are applied. Repository migration 0011_claims_feeds_moderation adds claims, claim evidence, custom feeds, contextual moderation state and additional hot-path indexes. 0011 is NOT production-applied until verified through the Admin database flow.
