...
export function createTursoDatabase(url:string,authToken:string,metrics=new RequestDbMetrics()):IntelDatabase {const client=createClient({url,authToken});return new TursoDatabase(client,metrics);}
