...
window.addEventListener('popstate',()=>{const u=new URL(location.href),id=u.searchParams.get('section')||'discussion',tab=document.querySelector(`.investigation-tabs a[data-panel="${CSS.escape(id)}"]`);if(tab instanceof HTMLElement)tab.click();});
})();